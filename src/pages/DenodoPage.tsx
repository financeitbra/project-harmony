  ...
  return (
    <div className="bg-background">
      ...
      <section
        ...
        style={{ background: `linear-gradient(135deg, ${denodoDark} 0%, #1a1a1a 100%)` }}
      >
        <div className="absolute inset-0 bg-grid-pattern opacity-[0.04]" />
        <div className="absolute inset-0">
          <div
            className="absolute left-[20%] top-0 h-full w-px"
            style={{ background: `linear-gradient(to bottom, transparent, ${denodoRed}12, transparent)` }}
          />
          <div
            className="absolute left-[60%] top-0 h-full w-px"
            style={{ background: `linear-gradient(to bottom, transparent, ${denodoRed}08, transparent)` }}
          />
          <div
            className="absolute right-[10%] top-[25%] h-[350px] w-[350px] rounded-full blur-[120px]"
            style={{ backgroundColor: `${denodoRed}10` }}
          />
          <div
            className="absolute left-[8%] bottom-[15%] h-[200px] w-[200px] rounded-full blur-[80px]"
            style={{ backgroundColor: `${denodoRedLight}12` }}
          />
        </div>
        <div className="relative section-padding">
          <div className="mx-auto max-w-4xl text-center">
            <div
              ...
              style={{ border: `1px solid ${denodoRed}50`, backgroundColor: `${denodoRed}18` }}
            >
              <span className="text-xs font-medium tracking-wide" style={{ color: denodoRedLight }}>
                Logical Data Management com Denodo
              </span>
            </div>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
              Com Denodo, a Financeit ajuda empresas a criar uma camada unificada de dados — acessando informações de
              múltiplas fontes em tempo real, sem duplicação, sem silos e com governança.
            </p>
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-white/50 md:text-base">
              O conceito de Logical Data Management permite que sua empresa trate fontes dispersas como se fossem uma
              base integrada, com mais agilidade, menos risco e menos complexidade de infraestrutura.
            </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground md:text-lg">
              Muitas empresas replicam dados entre sistemas, criam cópias em data warehouses separados e mantêm
              pipelines custosos apenas para consolidar informações. Isso gera latência, inconsistência e custos
              crescentes de manutenção.
            </p>
          </div>
            ...
            {[
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: `${denodoRed}15` }}
                >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 font-display text-2xl font-bold md:text-3xl lg:text-4xl">
              Logical Data Management: <span style={{ color: denodoRed }}>acesso unificado sem replicação.</span>
            </h2>
            <p className="mt-6 text-base leading-relaxed text-muted-foreground md:text-lg">
              Denodo cria uma camada lógica que conecta fontes heterogêneas — bancos de dados, APIs, data lakes,
              arquivos, ERPs e SaaS — permitindo que a empresa consuma dados integrados em tempo real, com governança e
              sem mover nada.
            </p>
          </div>
          <div className="mx-auto mt-14 grid max-w-4xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: "Controle de acesso, linhagem e políticas de segurança aplicados de forma consistente em toda a malha de dados.",
              },
              {
                icon: Database,
                title: "Data Fabric e Data Mesh",
                desc: "Suporte a arquiteturas modernas de dados com autonomia para domínios e governança federada.",
              },
              {
                icon: Target,
                title: "Self-service para negócio",
                desc: "Times de negócio acessam dados com autonomia, sem depender de tickets para engenharia de dados.",
              },
              {
                icon: Eye,
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 text-base leading-relaxed text-muted-foreground md:text-lg">
                A Financeit atua como parceira na adoção de Denodo, ajudando a traduzir necessidade de negócio em
                arquitetura de dados. Desde o mapeamento de fontes até a construção da camada lógica, nosso foco é gerar
                valor prático e governança real.
              </p>
            </div>
            <div className="space-y-4">
              {[
                ...
                <div
                  key={item}
                  className="flex items-center gap-4 rounded-lg border border-border bg-card px-6 py-4 transition-all hover:shadow-sm"
                >
                  <span
      ...
      >
        ...
        <div
          ...
          style={{ backgroundColor: `${denodoRed}08` }}
        />
