      ...
      <div className="container relative z-10 py-20 md:py-28 lg:py-36">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="font-display text-3xl font-extrabold leading-tight tracking-tight text-primary-foreground sm:text-4xl md:text-5xl lg:text-[3.25rem]">
            Sua empresa pode até experimentar IA sem base.{" "}
            <span className="text-gradient">Mas não vai escalar valor com ela.</span>
          </h1>

          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-primary-foreground/70 md:text-lg">
            Prontidão para IA é a capacidade de conectar dados, governança, contexto operacional e execução para transformar inteligência artificial em resultado real de negócio.
          </p>

          <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-primary-foreground/50 md:text-base">
            Antes de acelerar produtos, automações e iniciativas com IA, as empresas precisam resolver fundamentos. Sem isso, a tendência é acumular pilotos frágeis, baixa aderência, pouca escala e impacto limitado.
          </p>
