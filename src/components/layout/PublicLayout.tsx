...
const PAGE_META: Record<string, PageMeta> = {
  ...
  "/ppov": {
    title: "Planejamento Orçamentário e Gestão de Resultados — P-POV",
    description: "Planejamento orçamentário e gestão de resultados com P-POV: integre orçamento, realizado e projeções em uma única fonte da verdade para decisões financeiras mais rápidas e confiáveis.",
    keywords: "planejamento orçamentário, gestão de resultados, P-POV, orçamento empresarial, acompanhamento de resultado",
  },
  "/hunting-info": {
